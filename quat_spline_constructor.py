...
from mosi_utils_anim.animation_data.utils import convert_euler_frames_to_quaternion_frames
from mosi_utils_anim.utilities.io_helper_functions import get_semantic_motion_primitive_path
